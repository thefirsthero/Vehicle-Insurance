    ...
    <div className='d-flex'>
      ...
      <div className='sidebar justify-content-between flex-column bg-white text-dark py-5 ps-3 pe-2 vh-100 text-black m-0 text-center'>
          ...
          <button className={active === 2 ? 'active nav-item p-2' : 'nav-item p-2'} onClick={e => setActive(2)}>
            <span className='p-1'>
              <span className='text-decoration-none'>
                ...
                <span className='fs-4'><strong>Customers</strong></span>
              </span></span>
          </button>
        ...
        <ul className="nav nav-pills flex-column mt-3" >
          <a className='nav-item p-2' >
            
          
            <p><button type="button" className="btn btn-primary" onClick={handleLogout}><i className='bi bi-caret-left-fill me-3 fs-4'></i>Logout</button></p>
